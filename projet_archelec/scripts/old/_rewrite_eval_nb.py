...
with open('projet_archelec/notebooks/camembert_evaluation.ipynb', encoding='utf-8') as f:
    nb = json.load(f)
...
with open('projet_archelec/notebooks/camembert_evaluation.ipynb', 'w', encoding='utf-8') as f:
    json.dump(nb, f, ensure_ascii=False, indent=1)

print('Notebook reecrit avec', len(cells), 'cellules')
