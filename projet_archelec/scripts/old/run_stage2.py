...
assert STAGE1_MODEL.exists(), f"stage1_model manquant : {STAGE1_MODEL}"
print(f'OK stage1_model')
...
print(f'Modele Stage 1 charge ! Params : {sum(p.numel() for p in model.parameters()):,}')
...
print('\n=== EVALUATION TEST (2015-2020) — generalisation temporelle ===')
...
with open(RESULTS_DIR / 'stage2_metrics_test.json', 'w') as f:
    json.dump(results, f, indent=2)

stage2_dir = MODELS_DIR / 'stage2_model'
trainer.save_model(str(stage2_dir))
print(f'\nModele Stage 2 sauvegarde dans {stage2_dir}')
