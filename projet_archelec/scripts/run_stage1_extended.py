"""
Stage 1 élargi — CamemBERT sur distant supervision 1973–1993 (pre-2000)
Lit depuis data/bio_distantsup_extended/
Sauvegarde dans models/stage1_model_extended/
"""
...
BIO_DIR     = PROJECT_DIR / "data" / "bio_distantsup_extended"
...
args = TrainingArguments(
    output_dir                  = str(MODELS_DIR / 'stage1_extended_checkpoints'),
    num_train_epochs            = 5,
...
print('Entrainement Stage 1 elargi (1973-1993)...')
trainer.train()
print('Entrainement termine !')

print('\n=== EVALUATION TEST (distant supervision) ===')
...
with open(RESULTS_DIR / 'stage1_extended_results.json', 'w') as f:
    json.dump(results, f, indent=2)

stage1_dir = MODELS_DIR / 'stage1_model_extended'
trainer.save_model(str(stage1_dir))
print(f'\nModele sauvegarde dans {stage1_dir}')
print('ETAPE SUIVANTE : run_stage2.py (pointer sur stage1_model_extended)')
